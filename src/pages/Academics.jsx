...
export default function Academics() {
    return (
        <>
            ...
            <PageHeader
                title="Academics"
                subtitle="Our academic programmes combine strong theoretical foundations with practical technical training to prepare students for industry and higher education."
                variant="academics"
            />
